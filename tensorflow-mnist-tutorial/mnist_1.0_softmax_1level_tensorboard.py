...
with tf.name_scope("ReadDataSets"):
...
writer = tf.summary.FileWriter('e:\\temp\\tf\\log_tmp\\without1', sess.graph)
...
def training_step(i, update_test_data, update_train_data):
    ...
    rs = sess.run(merged, feed_dict={X: batch_X, Y_: batch_Y})
